...
class CircleTracker(Node):
    def __init__(self):
        ...
        self.declare_parameter('max_tracker_err_param', 25)
        ...
        self.targetRadius = 50.0 # ADJUST BASED OFF OF HOW FAR WE WANT DRONE TO SIT!!
    
    # TRACKING LOCATION OF CIRCLE
    # node should make calls to find_circle in a separate thread to update circle location when possible
